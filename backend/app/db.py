...
class DatabaseManager:
    ...
    def _legacy_init_db(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            # ALTER TABLE migrations for copilot settings columns
    ...
    async def save_copilot_hint(self, meeting_id: str, topic_detected: str, talking_points: list, genie_used: bool, genie_answer: Optional[str]) -> str:
        """Insert hint. Returns new hint id."""
