          ...
          return (
            <div
              ...
              className={cn(
                ...
                modelIsDownloading
                  ? 'bg-[var(--panel-bg)] border-[var(--separator)]'
                  : 'bg-card',
                selectedModel === model.name
                  ? 'ring-2 ring-gray-800 border-gray-800'
                  : 'border-[var(--separator)] hover:border-gray-300',
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-base font-bold text-[var(--text-primary)]">{model.display_name || model.name}</span>
                    {isAvailable && (
                      <>
                ...
                <div className="ml-4 flex items-center gap-2">
                  ...
                  {isAvailable && !modelIsDownloading && selectedModel !== model.name && (
                    <button
                      className="p-2 rounded hover:bg-gray-100 transition-colors text-[var(--text-secondary)] hover:text-red-600"
                      onClick={(e) => {
                        e.stopPropagation();
                        deleteModel(model.name);
                      }}
              ...
              {modelIsDownloading && progress !== undefined && (
                <div className="mt-3 pt-3 border-t border-[var(--separator)]">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-sm font-medium text-[var(--text-primary)]">Downloading...</span>
                  ...
                  <div className="w-full h-2.5 bg-[var(--panel-elevated)] rounded-full overflow-hidden">
                    <div
