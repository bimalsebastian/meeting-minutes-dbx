  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-semibold text-[var(--text-primary)] mb-2">Usage Analytics</h3>
        ...
        <div className="flex items-center justify-between p-3 bg-[var(--panel-elevated)] rounded-lg border border-[var(--separator)]">
          <div>
            <h4 className="font-semibold text-[var(--text-primary)]">Enable Analytics</h4>
          ...
          <div className="p-4 border rounded-lg bg-[var(--panel-elevated)]">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="font-medium text-[var(--text-primary)] mb-1">Your User ID</div>
                <p className="text-xs text-[var(--text-secondary)] mb-2">
                  Share this ID when reporting issues to help us investigate your issue logs
                </p>
                <div className="flex items-center gap-2">
                  <code className="text-xs text-[var(--text-primary)] bg-[var(--panel-bg)] px-2 py-1 rounded border border-[var(--separator)] font-mono flex-1 truncate">
                    {userId}
                  </code>
                  <Button
