    ...
    <ButtonGroup>
      ...
      {isGenerating ? (
        <Button
          variant="outline"
          size="sm"
          className="xl:px-4" style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)' }}
          onClick={() => {
        ...
        <Button
          variant="outline"
          size="sm"
          className="xl:px-4" style={{ background: 'rgba(0,122,255,0.10)', border: '1px solid rgba(0,122,255,0.25)' }}
          onClick={() => {
