    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          <div className="h-4 bg-[var(--panel-elevated)] rounded w-1/3 mb-4"></div>
          <div className="h-10 bg-[var(--panel-elevated)] rounded mb-3"></div>
          <div className="h-10 bg-[var(--panel-elevated)] rounded"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-medium text-[var(--text-primary)]">Audio Devices</h4>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="mic-selection" className="text-sm font-medium text-[var(--text-primary)]">
              Microphone
            </Label>
          </div>
          <Select
          ...
          {inputDevices.length === 0 && (
            <p className="text-xs text-[var(--text-secondary)]">No microphone devices found</p>
          )}
          ...
          {showLevels && inputDevices.length > 0 && (
            <div className="space-y-2 pt-2 border-t border-[var(--separator)]">
              <p className="text-xs text-[var(--text-secondary)] font-medium">Microphone Levels:</p>
              {inputDevices.map((device) => {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Speaker className="h-4 w-4 text-[var(--text-secondary)]" />
            <Label htmlFor="system-selection" className="text-sm font-medium text-[var(--text-primary)]">
              System Audio
            </Label>
          </div>
          ...
          {outputDevices.length === 0 && (
            <p className="text-xs text-[var(--text-secondary)]">No system audio devices found</p>
          )}
