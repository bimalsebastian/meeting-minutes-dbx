  ...
  return isEditing ? (
    <div className="flex-1">
      <textarea
        ...
        className="text-2xl font-bold bg-[var(--panel-elevated)] border border-[var(--separator)] focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-3 py-1 w-full resize-none overflow-hidden"
