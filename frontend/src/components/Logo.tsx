  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span className="text-lg text-center rounded-full font-semibold mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity" style={{ background: 'rgba(0,122,255,0.12)', border: '1px solid var(--separator)', color: 'var(--text-primary)' }}>
            <span>Meetily</span>
          </span>
        </DialogTrigger>
      )}
