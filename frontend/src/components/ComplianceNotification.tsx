...
export const ComplianceNotification: React.FC<ComplianceNotificationProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-[var(--panel-bg)] border border-[var(--separator)] rounded-lg shadow-lg p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <button
            onClick={handleClose}
            className="text-[var(--text-secondary)] hover:text-gray-600 transition-colors p-0.5 rounded hover:bg-gray-100"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
