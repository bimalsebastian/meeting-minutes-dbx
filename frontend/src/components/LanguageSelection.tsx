    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-sm font-medium text-[var(--text-primary)]">Transcription Language</h4>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-[var(--panel-bg)] border border-[var(--separator)] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
        >
